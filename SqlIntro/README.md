...
1.	What is SQL? What is DML? What is DDL? Recite the most important SQL commands.
	*	**Answers:**
		*	SQL stands for Structured Query Language. It is a special-purpose programming language designed for managing data in a relational database.
		*	DML stands for Data Manipulation Language. It is used for selecting, inserting, deleting and updating data in a database.
			*	Commands: SELECT, INSERT, UPDATE, DELETE.
		*	DDL stands for Data Definition Language. It is used to modify the schema of the database by adding, changing, or deleting definitions of tables or other objects.
			*	Commands: CREATE, DROP, ALTER; GRANT, REVOKE.
1.	What is Transact-SQL (T-SQL)?
	*	**Answer:**
		*	T-SQL is an extension to SQL. It includes procedural programming, local variables, various support functions for string processing, date processing, mathematics, etc. and changes to the DELETE and UPDATE statements.
